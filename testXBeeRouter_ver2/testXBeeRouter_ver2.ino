...
#endif
#ifdef ROUTER3
String startAck = "startAck3"; // コネクション許可応答
String senData = "ROUTER3sensor"; // センサー値(仮)
#endif
#ifdef ROUTER4
String startAck = "startAck4"; // コネクション許可応答
String senData = "ROUTER4sensor"; // センサー値(仮)
#endif
#ifdef ROUTER5
String startAck = "startAck5"; // コネクション許可応答
String senData = "ROUTER5sensor"; // センサー値(仮)
#endif
#ifdef ROUTER6
String startAck = "startAck6"; // コネクション許可応答
String senData = "ROUTER2sensor"; // センサー値(仮)
#endif
